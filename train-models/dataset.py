...
class DataSet:
    def __init__(self, in_dir, exts='.png'):
        ...
        For example, the collision data-set has the
        following dir-structure:

        images/collision/
        images/nocollision/

        This means there are 2 classes called: collision, no collision.

        If we set in_dir = "images/" and create a new DataSet-object
        then it will scan through these directories and create a training-set
        and test-set for each of these classes.

        The training-set will contain a list of all the *.png filenames
        in the following directories:

        images/collision/
        images/nocollision/

        The test-set will contain a list of all the *.png filenames
        in the following directories:

        images/collision/test/
        images/nocollision/test/
        ...
        :param in_dir:
            ...
            This would be 'images/' in the example above.
    ...
    def copy_files(self, train_dir, test_dir):
        ...
        images/train/collision/
        images/train/nocollision/


        and for the test-set:
        
        images/test/collision/
        images/test/nocollision/

        :param train_dir: Directory for the training-set e.g. 'images/train/'
        :param test_dir: Directory for the test-set e.g. 'images/test/'
        :return: Nothing. 
        """
